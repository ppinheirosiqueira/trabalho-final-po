...
def criando_cidades() -> list:
    ...
    cidades.append(Cidade(5, "Ariquemes", [-9.906218, -63.033006], 6941, True, 1, 0.6, 3))
    ...
    cidades.append(Cidade(23, "Jaru", [-10.428357, -62.473662], 3983, True, 1, 0.6, 4))
    cidades.append(Cidade(24, "Ji-Paraná", [-10.878141, -61.932673], 9730, True, 2, 0.6, 4))
    ...
    cidades.append(Cidade(35, "Pimenta Bueno", [-11.677457, -61.178759], 2787, True, 1, 0.6, 7))
    cidades.append(Cidade(36, "Pimenteiras do Oeste", [-13.481384, -61.046885], 169, False, 0, 0.6, 8))
    cidades.append(Cidade(37, "Porto Velho", [-8.763547, -63.897172], 33075, True, 5, 0.6, 1))
    ...
    cidades.append(Cidade(41, "Rolim de Moura", [-11.725698, -61.778141], 4117, True, 1, 0.6, 6))
    ...
    cidades.append(Cidade(52, "Vilhena", [-12.738459, -60.122151], 6187, True, 2, 0.45, 7))
    return cidades
